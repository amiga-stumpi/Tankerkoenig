...
$(STATIONS_TEST): src/json.c src/stations.c tests/stations_test.c | $(BUILD)
	$(HOST_CC) -std=c89 -Wall -Wextra -pedantic -Itests/host_include -Iinclude -o $@ src/json.c src/stations.c tests/stations_test.c
